"""Drive the DesktopLUT FALD correction layer over the calibration pipe (HDR, monitor 0 by default).
  ...
  python fald_layer.py debug <0..3>              0 correct, 1 show gain-1 (grey 0.5 = no change), 2 B_true, 3 B_est
  python fald_layer.py dump <dir>                next frame dumps drive/B_true/B_est/frame to <dir>
