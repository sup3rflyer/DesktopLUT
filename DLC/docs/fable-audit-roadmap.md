...
- **Updated:** 2026-07-05, Phase 1 complete on `claude/fable-audit-phase-1-78qq6b`
  ...
  (`tests/test_color_goldens.py`). NOTE: Phase 0 has not run — its skipif/coverage/
  README deliverables are still owed and the 8 `test_engine.py` environment
  failures still show red.
...
- [x] Phase 1 — Colour-math foundations & duplication *(2026-07-05, `claude/fable-audit-phase-1-78qq6b` — see `docs/audits/fable/phase-1.md`; ran before Phase 0, whose deliverables remain owed)*
