...
tool files. Keep that manifest with run evidence when checking which contained
toolchain was used. `dlc preflight` reports whether this manifest is present and
